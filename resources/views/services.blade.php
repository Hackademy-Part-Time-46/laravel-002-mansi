    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <a class="navbar-brand" href="/">Sito Aulab</a>
        ...
        <section class="py-5">
            <div class="container px-5 my-5">
                            ...
                            <div class="border-0 shadow card h-100">
                                ...
                                <div class="p-4 card-body">
                                    <a class="text-decoration-none link-dark stretched-link"
                                        href="/dettaglio-servizio/{{ $service }}">
                                        <h5 class="mb-3 card-title">{{ $service }}</h5>
                                    </a>
                ...
                <!-- Call to action-->
                <aside class="p-4 mt-5 bg-primary bg-gradient rounded-3 p-sm-5">
                    <div
                        class="text-center d-flex align-items-center justify-content-between flex-column flex-xl-row text-xl-start">
                        <div class="mb-4 mb-xl-0">
                            <div class="text-white fs-3 fw-bold">New products, delivered to you.</div>
